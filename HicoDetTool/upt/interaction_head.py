...
from .util.pocket import FeedForwardNetwork, TransformerEncoderLayer
...
class ModifiedEncoderLayer(nn.Module):
    def __init__(self,
        ...
        self.ffn = FeedForwardNetwork(hidden_size, hidden_size * 4, dropout_prob)
...
class InteractionHead(nn.Module):
    ...
    def __init__(self,
        ...
        self.comp_layer = TransformerEncoderLayer(
