...
if __name__ == "__main__":
    ...
    """
        run = wandb.init(project="affordance_image",
                     config={"base_image_model": base_image_model,
    ...
    model_ft, image_feature_extractor, bert_tokenizer = initialize_image_bert_model(base_image_model, base_bert_model, num_classes)
