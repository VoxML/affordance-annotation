...
def run(args):
    ...
    results = processor.process_images_in_folder(args.input_folder, with_feature=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_file', default="results_hico_merge_2015_v2_with-unary-token.json", type=str)
