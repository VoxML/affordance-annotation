...
pickle.dump(actions_up_array, open("actions_up_array.pkl", "wb"))
pickle.dump(actions_up_cond_prob, open("actions_up_cond_prob.pkl", "wb"))
pickle.dump(actions_up_joint_prob, open("actions_up_joint_prob.pkl", "wb"))